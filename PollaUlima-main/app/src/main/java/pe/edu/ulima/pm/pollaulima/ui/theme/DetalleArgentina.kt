...
@Composable
fun DetalleArgentina() {
    val navController = rememberNavController()
    NavHost(
        navController = navController,
        startDestination = "DetalleArgentina"){
        composable(route = "DetalleArgentina"){
            MainDetalleArgentina(navController = navController)
        }
...
@Composable
fun MainDetalleArgentina(navController: NavController) {
    ...
    Column(
        ...
        Image(painter = painterResource(R.drawable.aargentina),
