...
fun DetalleGhana() {
    ...
    NavHost(
        ...
        startDestination = "DetalleGhana"){
        composable(route = "DetalleGhana"){
            MainDetalleGhana(navController = navController)
        }
...
@Composable
fun MainDetalleGhana(navController: NavController) {
    ...
    Column(
        ...
        Image(painter = painterResource(R.drawable.gghana),
