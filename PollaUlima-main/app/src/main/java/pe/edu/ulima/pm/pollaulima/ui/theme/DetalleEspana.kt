...
fun DetalleEspana() {
    ...
    NavHost(
        ...
        startDestination = "DetalleEspana"){
        composable(route = "DetalleEspana"){
            MainDetalleEspana(navController = navController)
        }
...
@Composable
fun MainDetalleEspana(navController: NavController) {
